                ...
                <form action="{{ route('admin.product.update', $product->id) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <input type="text" name="name" value="{{ $product->name }}" maxlength="220"
                        ...
                        <div class="col-sm-12 mb-3">
                            <label for="description" class="form-label">Description <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="description" value="{{ $product->description }}" maxlength="220"
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <select name="category_id" id="category_id"
                                ...
                                <option value="{{ $id }}" @selected($product->category_id==$id)>{{ $category }}</option>
                                @empty
                                @endforelse
                            </select>
                            @error('category_id')
                        ...
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-primary px-5 float-end">Update Product</button>
                        </div>
                    </div>
                </form>
            </div>
