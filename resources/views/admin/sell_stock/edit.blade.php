    ...
    <div class="col-md-12 col-sm-12 mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.sell-stock.update', $sell_stock->id) }}" method="post">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 mb-2">
                            ...
                            <select name="customer_id" id="customer_id"
                                ...
                                <option value="{{ $customer->id }}" @selected($sell_stock->user_id == $customer->id)>{{
                        ...
                        <div class="col-md-6 col-sm-12 mb-2">
                            ...
                            <input type="date" name="date" id="date"
                                value="{{ $sell_stock->invoice_date ?? date('Y-m-d') }}"
                        ...
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-primary px-5 float-end">Update Sell Stock</button>
                        </div>
...
<script>
    ...
    $('#add_invoice_qty').click(function(){
        ...
        var modal_location = $('#modal_location').val();
