...
@section('title', 'Order Stock Update')
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Order Stock</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-md-12 col-sm-12 mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.order-stock.update', $orderStock->id) }}" method="post">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            ...
                            <select name="supplier_id" id="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $supplier->id }}" @selected($orderStock->supplier_id == $supplier->id)>{{ $supplier->name }}</option>
                                @endforeach
                            </select>
                            @error('supplier_id')
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            ...
                            <input type="date" name="issue_date" id="daissue_datete" value="{{ $orderStock->issue_date ?? date('Y-m-d') }}"
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            ...
                            <input type="date" name="receipt_date" id="receipt_date" value="{{ $orderStock->receipt_date ?? date('Y-m-d') }}"
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="number" min="1" name="tax" id="tax" value="{{ $orderStock->tax }}"
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" name="product_location" id="product_location"
                                class="form-control @error('product_location') is-invalid @enderror" value="{{ $orderStock->location }}" required>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <textarea name="bill_to" id="bill_to" rows="5"
                                ...
                                placeholder="Bill To" required>{{ $orderStock->bill_to }}</textarea>
                            @error('bill_to')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            <label for="ship_to" class="form-label">Ship To &nbsp; &nbsp;
                                <input class="form-check-input" type="checkbox" id="ship_to_check" name="ship_to_check" {{ $orderStock->ship_to_check ? 'checked' : '' }}>
                                <label class="form-check-label" for="ship_to_check">
                                    Same as Bill to
                                </label>
                            </label>
                            <textarea name="ship_to" id="ship_to" rows="5"
                                class="form-control @error('ship_to') is-invalid @enderror" placeholder="Ship To">{{ $orderStock->ship_to }}</textarea>
                            @error('ship_to')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" name="tracking_ref" id="tracking_ref" value="{{ $orderStock->tracking_ref }}"
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" name="shiped_by" id="shiped_by" value="{{ $orderStock->shiped_by }}"
                        ...
                        <div class="col-md-12 col-sm-12 mb-3">
                            <table class="table table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody id="add_invoice_items">
                                    @if(!empty($orderStock->orderLists))
                                        @foreach ($orderStock->orderLists as $list)
                                            <tr class="invoice_row">
                                                <td>
                                                    <input type="text" class="form-control" name="product_name[]"
                                                        value="{{ $list->product->name }}" readonly>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control selling_price" name="unit_total[]"
                                                        value="{{ $list->unit_total }}" readonly>
                                                </td>
                                                <td>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <textarea name="order_note" id="order_note" rows="5"
                                ...
                                placeholder="Order Note" required>{{ $orderStock->order_note }}</textarea>
                            @error('order_note')
                                <div class="text-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-3">
                            ...
                            <textarea name="internal_notes" id="internal_notes" rows="5"
                                ...
                                placeholder="Internal Notes" required>{{ $orderStock->internal_notes }}</textarea>
                        ...
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-primary px-5 float-end">Update Order</button>
                        </div>
